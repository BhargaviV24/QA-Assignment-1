                    ...
                    else
                    {
                        switch (selectedValue)
                        {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                Console.Write($"The rectangle length is - {objRectangle.GetWidth()}\n");
                                break;
                            ...
                            case 5:
                                Console.Write($"The rectangle length is - {objRectangle.GetPerimeter()}\n");
                                break;

                            case 6:
                                Console.Write($"The rectangle length is - {objRectangle.GetArea()}\n");
                                break;
                            case 7:
                                isRunning = false;
                                break;
